 ...
 * </pre>
 */
public class OVFManagerImportLocalVApp extends BaseCommand {
        ...
        public void run() {
            try {
                while (!vmdkFlag) {
                    ...
                    try {
                        vcService.getVimPort().httpNfcLeaseProgress(httpNfcLease, progressPercent);
    ...
    ManagedObjectReference getDatacenterOfDatastore(
        ...
        List<ObjectContent> oCont =
                vcService.getVimPort().retrievePropertiesEx(vcService.getServiceContent().getPropertyCollector(),
    ...
    public void importVApp() {
        try {
            ManagedObjectReference dsMor = null;
            ManagedObjectReference rpMor = null;
            Map<String, ManagedObjectReference> results = null;
            try {
                results = vcService.getGetMOREFs().inFolderByType(vcService.getServiceContent().getRootFolder(), "HostSystem",
                        new RetrieveOptions());
            ...
            Map<String, Object> hostProps =
                    vcService.getGetMOREFs().entityProps(hostMor, new String[]{"datastore", "parent"});
            ...
            if (datastore == null) {
                ...
                for (ManagedObjectReference ds : dsList) {
                    if (datastore.equalsIgnoreCase((String) vcService.getGetMOREFs().entityProps(ds,
            ...
            rpMor =
                    (ManagedObjectReference) vcService.getGetMOREFs().entityProps(
            ...
            OvfCreateImportSpecResult ovfImportResult =
                    vcService.getVimPort().createImportSpec(vcService.getServiceContent().getOvfManager(),
            ...
            ManagedObjectReference httpNfcLease =
                    vcService.getVimPort().importVApp(rpMor, ovfImportResult.getImportSpec(),
                            vmFolder, hostMor);
            Object[] result =
                    vcService.getWaitForValues().wait(httpNfcLease, new String[]{"state"},
            ...
            if (result[0].equals(HttpNfcLeaseState.READY)) {
                ...
                HttpNfcLeaseInfo httpNfcLeaseInfo =
                        (HttpNfcLeaseInfo) vcService.getGetMOREFs().entityProps(httpNfcLease,
                ...
                vmdkFlag = true;
                t.interrupt();
                vcService.getVimPort().httpNfcLeaseProgress(httpNfcLease, 100);
                vcService.getVimPort().httpNfcLeaseComplete(httpNfcLease);
            } else {
    ...
    void getVMDKFile(boolean put, String fileName, String uri,
        ...
        try {
            ...
            List<String> cookies = (List<String>) vcService.getHeaders().get("Set-cookie");
            ...
            ((BindingProvider) vcService.getVimPort()).getRequestContext().put(
