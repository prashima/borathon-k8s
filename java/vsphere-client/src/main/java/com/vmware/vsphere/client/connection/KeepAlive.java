...
/**
 * This is a keep-alive utility class. It will keep an instance of a com.vmware.vsphere.client.connection alive by polling the "currentTime"
 * method on the remote Host or vCenter that the supplied com.vmware.vsphere.client.connection and VimPortType were talking to.
...
public class KeepAlive implements Runnable {
    ...
    /**
     * kicks off a thread that will call the "keep alive" method on the com.vmware.vsphere.client.connection instance
     */
    ...
    /**
     * Returns a thread you can start to run a keep alive on your com.vmware.vsphere.client.connection. You supply it with your copy of
