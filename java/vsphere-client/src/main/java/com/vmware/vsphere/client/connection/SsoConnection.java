...
public class SsoConnection implements Connection {
    ...
    /**
     * the cached headers gleaned from the last com.vmware.vsphere.client.connection atttempt
     * @return
     */
    @SuppressWarnings("rawtypes")
	@Override
    ...
    /**
     * This method is here to separate out the exception handling from the logic of actually forming a com.vmware.vsphere.client.connection.
     * The method forms the com.vmware.vsphere.client.connection but does not handle any exceptions.
     * <p>
    ...
    /**
     * returns true if the com.vmware.vsphere.client.connection is open, and hasn't timed out. Connections time-out every 30 minutes.
     * @return true if a good, non-stale com.vmware.vsphere.client.connection
     */
    @Override
    ...
    /**
     * properly disconnect the com.vmware.vsphere.client.connection and set stale objects to "null" to help the garbage collector
    ...
    public Connection disconnect() {
        if (this.isConnected()) {
            try {
                ...
                // A com.vmware.vsphere.client.connection is very memory intensive, I'm helping the garbage collector here
                userSession = null;
                serviceContent = null;
                vimPort = null;
                vimService = null;
    ...
    /**
     * gets the URL used for this com.vmware.vsphere.client.connection
     * @return
     */
    @Override
    public URL getURL() {
