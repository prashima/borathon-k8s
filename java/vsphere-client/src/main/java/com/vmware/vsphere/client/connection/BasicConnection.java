...
/**
 * This simple object shows how to set up a vSphere com.vmware.vsphere.client.connection as it was done in vSphere 4.x and is provided
 ...
 * <p>
 * Samples that need a com.vmware.vsphere.client.connection open before they can do anything useful extend VcService so that the
