 ...
 * </pre>
 */
public class VMLinkedClone extends BaseCommand {
     ...
     */
    public String createLinkedClone() throws RuntimeFaultFaultMsg, InvalidPropertyFaultMsg, CustomizationFaultFaultMsg, TaskInProgressFaultMsg, VmConfigFaultFaultMsg, InsufficientResourcesFaultFaultMsg, InvalidDatastoreFaultMsg, FileFaultFaultMsg, MigrationFaultFaultMsg, InvalidStateFaultMsg, InvalidCollectorVersionFaultMsg {
        ManagedObjectReference propCol = vcService.getConnection().getServiceContent().getPropertyCollector();
        ManagedObjectReference vmMOR = vcService.getGetMOREFs().vmByVMname(virtualMachineName, propCol);
        ManagedObjectReference cloneMor = null;
        if (vmMOR != null) {
            ...
            if (snapMOR != null) {
                ...
                ManagedObjectReference parentMOR =
                        (ManagedObjectReference) vcService.getGetMOREFs().entityProps(vmMOR,
                ...
                ManagedObjectReference cloneTask =
                        vcService.getVimPort()
                                .cloneVMTask(vmMOR, parentMOR, cloneName, cloneSpec);
                if (getTaskResultAfterDone(cloneTask)) {
                    cloneMor =
                            (ManagedObjectReference) vcService.getGetMOREFs().entityProps(cloneTask,
    ...
    ArrayList<Integer> getIndependenetVirtualDiskKeys(
        ...
        VirtualHardware hw =
                (VirtualHardware) vcService.getGetMOREFs().entityProps(vmMOR,
    ...
    ManagedObjectReference getSnapshotReference(
        ...
        VirtualMachineSnapshotInfo snapInfo =
                (VirtualMachineSnapshotInfo) vcService.getGetMOREFs().entityProps(vmmor,
