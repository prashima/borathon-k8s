...
import com.vmware.vsphere.client.connection.helpers.builders.*;
...
public class GetMOREF extends BaseHelper {
    ...
    /**
     * Initialize the helper object on the current com.vmware.vsphere.client.connection at invocation time. Do not initialize on construction
     * since the com.vmware.vsphere.client.connection may not be ready yet.
     */
    private void init() {
        try {
