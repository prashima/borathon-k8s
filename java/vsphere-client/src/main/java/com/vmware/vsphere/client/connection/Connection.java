...
/**
 * This simple object shows how to set up a vCenter com.vmware.vsphere.client.connection. It is intended as a utility class for use
...
//    @Option(name = "username", systemProperty = "com.vmware.vsphere.client.connection.username", description = "username on remote system")
    void setUsername(String username);

    String getUsername();

//    @Option(name = "password", systemProperty = "com.vmware.vsphere.client.connection.password", description = "password on remote system")
